import os,sys
now_dir = "extensions/silero_tts_rvc"
...
def output_modifier(string, state):
    ...
    if string == '':
        ...
        output_file = Path(f'extensions/silero_tts_rvc/outputs_temp/{state["character_menu"]}_{int(time.time())}.wav')
        ...
        output_file_rvc_as_path = Path(f'extensions/silero_tts_rvc/outputs/{state["character_menu"]}_{int(time.time())}.wav')
